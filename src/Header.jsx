                    ...
                    <div className="container mx-auto flex flex-wrap items-center justify-between">
                        ...
                        <div className="flex md:order-2">
                            <div className="relative mr-3 md:mr-0 hidden md:block">
                                ...
                                <input type="text" id="email-address-icon" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2" placeholder="Search..." />
                            </div>
                            <button
                                onClick={toggleMenu}
                                type="button"
                        ...
                        <div className={`${menuOpen ? 'block' : 'hidden'} md:flex justify-between items-center w-full md:w-auto md:order-1`} id="mobile-menu-3">
